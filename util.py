                    ...
                    if line_id < end:
                        ...
                        if len(line) == 5:
                            ...
                            while len(tokens) < args.seq_length:
                                tokens.append(0)
                            dataset.append((tokens, tokens_triples, id2_list, label, length, text))
                        else:
                            pass
        return dataset
...
def batch_loader(batch_size, input_ids, triples_ids, label_ids, length_ids, id2_ids):
    ...
    for i in range(instances_num // batch_size):
        ...
        yield input_ids_batch, triples_ids_batch, id2_ids_batch, label_ids_batch, length_ids_batch
